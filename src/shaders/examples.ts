...
export const infiniteSpheres = glsl`float GetDis(vec3 pos) {
...
export const howTo = glsl`float GetDis(vec3 pos) {
    /*
    In this function you want to return the distance from 
    the position to the object.
    For example, if you want to create a sphere at the origin
    with radius 1, you would do:
    */
...
vec3 GetAlbedo(vec3 pos) {
    /*
    In this function you want to return the color of the object
    at the position.
